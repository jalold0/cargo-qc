...
export function normalizeOtkEntry(entry = {}) {
  ...
  return {
    ...
    isRepeat: Boolean(source.isRepeat ?? source.is_repeat),
    repeatOfId: source.repeatOfId || source.repeat_of_id || null,
    repeatIndex: Number(source.repeatIndex ?? source.repeat_index) || 0,
